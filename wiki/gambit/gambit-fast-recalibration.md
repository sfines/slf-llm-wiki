...
- **Modular Defense:** Swapping out specialized [Harness Components](../agentic-harness/agent-harness.md) (e.g., execution guards) in response to new failure modes identified by an [Agent Debugger](../agentic-harness/ahe-agent-debugger.md).
