...
The **GAMBIT Benchmark** evaluates [Imposter Detectors](gambit-detector-evaluation.md) across three distinct modes designed to simulate the evolution of adversarial attacks in [Multi-Agent Systems](../core-concepts/multi-agent-systems.md).
