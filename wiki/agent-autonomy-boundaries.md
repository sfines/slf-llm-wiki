...
An **Autonomy Boundary** defines the explicit limit of an [AI Agent's](autonomous-agents.md) power to make decisions and take actions without external approval.
...
- **Outside the Boundary:** The agent must seek "Human-in-the-loop" approval or coordinate with a higher-level [Coordinator Agent](agyn-framework.md#agent-roles).
