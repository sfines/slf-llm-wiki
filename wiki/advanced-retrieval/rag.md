...
In [Agentic DDD](../agentic-ddd/agentic-ddd-overview.md), RAG systems are often indexed using the [Ubiquitous Language](../agentic-ddd/ubiquitous-language-for-ai.md) to ensure the agent retrieves information that is semantically aligned with the domain.
