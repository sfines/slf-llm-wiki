...
**Team-Based Autonomous Software Engineering** is a paradigm where complex software tasks are solved by a collaborative team of specialized [Autonomous Agents](autonomous-agents.md) rather than a single "Generalist" agent.
...
- **[Confucius Code Agent](confucius-code-agent.md):** Uses a meta-agent to refine configurations and hierarchical memory to support team-like scale.
