...
While foundation models come with broad parametric memory, specialized agents often use **Parameter-Efficient Fine-Tuning (PEFT)** or **LoRA** to encode specific domain rules or [Ubiquitous Language](../agentic-ddd/ubiquitous-language-for-ai.md) that should be "second nature" to the agent.
