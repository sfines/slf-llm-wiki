...
**Working Memory** in [Autonomous Agents](../core-concepts/autonomous-agents.md) refers to the information currently "held in mind" for the immediate reasoning step or task session.
...
- **[Hierarchical Working Memory](../confucius/confucius-hierarchical-memory.md):** Organizing information into layers (goals, sub-tasks, episodic detail) to prevent context saturation.
...
- [Confucius Hierarchical Working Memory](../confucius/confucius-hierarchical-memory.md)
