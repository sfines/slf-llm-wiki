...
**Structured Communication** refers to the formalized protocols and channels through which agents in a [Multi-Agent System (MAS)](../core-concepts/multi-agent-systems.md) exchange information.
...
- **Knowledge Sharing:** A shared [Working Memory](../agent-memory/agent-working-memory.md) or blackboard where agents can post findings for others to consume.
