...
**User Experience (UX)** in the [Confucius SDK](confucius-code-agent.md) focuses on the human developer's ability to monitor, control, and trust the [Autonomous Agent](autonomous-agents.md).
