...
While [Factual Memory](agent-factual-memory.md) focuses on external data (RAG), Adaptive Memory focuses on **Internal Strategic Knowledge**—the "how-to" knowledge learned through experience.
