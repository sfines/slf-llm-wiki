...
Storage of past agent trajectories. Critical for [Continual Learning](continual-learning.md) and self-improvement.

### 3. [Factual Memory](agent-factual-memory.md)
Long-term storage of declarative knowledge. Often implemented using [RAG](rag.md) or **[Parametric Realizations](agent-parametric-memory.md)**.
