...
**Strategic Mapping Protocols** define the formalized rules for interaction between [Bounded Contexts](bounded-contexts-in-mas.md) in a [Multi-Agent System](../core-concepts/multi-agent-systems.md).
...
The [Model Context Protocol (MCP)](../core-concepts/mcp.md) serves as a modern realization of these protocols, providing a standardized way to define the capabilities and constraints of these mappings.
