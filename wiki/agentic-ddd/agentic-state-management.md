...
State management in [Agentic DDD](agentic-ddd-overview.md) relies on the patterns of [Entities and Aggregates](../core-concepts/domain-driven-design.md) to ensure consistency and business integrity.
...
- **Test-Time Memory:** Specialized caching or memory mechanisms (like [Agentic Plan Caching](../core-concepts/agentic-plan-caching.md)) that help agents remember successful strategies across different tasks.
