...
**Event Storming** is a collaborative discovery technique used in [Agentic DDD](agentic-ddd-overview.md) to model the behavior and interactions of [Multi-Agent Systems (MAS)](../core-concepts/multi-agent-systems.md).
