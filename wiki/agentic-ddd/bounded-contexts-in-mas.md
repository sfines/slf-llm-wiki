...
In [Agentic Domain-Driven Design](agentic-ddd-overview.md), **Bounded Contexts** serve as the foundational boundaries for [AI Agents](../core-concepts/autonomous-agents.md).
