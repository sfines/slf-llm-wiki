...
Agentic Domain-Driven Design is an architectural framework that adapts traditional [Domain-Driven Design (DDD)](../core-concepts/domain-driven-design.md) principles to the development of [Autonomous AI Agents](../core-concepts/autonomous-agents.md) and [Multi-Agent Systems (MAS)](../core-concepts/multi-agent-systems.md).
...
[Event Storming](../core-concepts/event-storming.md) is used to identify **[Domain Events](domain-events-as-triggers.md)**, which serve as the primary triggers for agent actions and communication between different agents in a system.
