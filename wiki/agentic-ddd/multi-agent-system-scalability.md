...
Scalability in [Agentic DDD](agentic-ddd-overview.md) is achieved by leveraging the modularity and decoupling inherent in [Domain-Driven Design](../core-concepts/domain-driven-design.md).
