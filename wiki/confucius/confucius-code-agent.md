...
- **[Persistent Note-Taking System](confucius-persistent-notes.md):** Enables cross-session [Continual Learning](../core-concepts/continual-learning.md) by allowing agents to save and retrieve domain-specific insights.
