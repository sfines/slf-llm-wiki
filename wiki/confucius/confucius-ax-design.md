...
- **Maximize Signal-to-Noise:** Ensuring that [Working Memory](../agent-memory/agent-working-memory.md) contains high-relevance information and minimal distraction.
