...
- **Action Hallucination:** Identifying when an agent attempts to use a tool that has not been defined in its current [Bounded Context](bounded-contexts-in-mas.md).
