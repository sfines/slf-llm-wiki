...
**Token-Level Memory** is the most common form of memory in foundation model-based [Autonomous Agents](autonomous-agents.md), relying on the model's self-attention mechanism over a sequence of tokens.
...
- **[Hierarchical Working Memory](confucius-hierarchical-memory.md):** Organizing tokens into logical layers to maximize relevance.
