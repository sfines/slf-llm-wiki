...
In the context of [Autonomous Agents](../core-concepts/autonomous-agents.md), a **Harness** (or Scaffolding) is the infrastructure layer that mediates between the LLM and the external world.

## Components of a Harness
A typical harness includes:
- **System Prompts:** The core instructions and persona definitions.
- **Tool Definitions:** API schemas and descriptions for the model to use (e.g., [MCP](../core-concepts/mcp.md)).
