...
**Automated Aggregate Design** is the fourth stage of the [Automating DDD Framework](ddd-prompting-framework.md), focusing on the internal structure of [Bounded Contexts](../agentic-ddd/bounded-contexts-in-mas.md).
